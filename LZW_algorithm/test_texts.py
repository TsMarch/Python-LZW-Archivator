...
text_1 = """We can't imagine our life without books. They play a very important part in our life. Books are our friends. We meet them when we are very small and can't read, but we remember our mother read them for us. We learn very much from books.
...
text_3 = """To be, or not to be - that is the question:
...
text_4 = """A great number of items in collections of books, newspapers, periodicals, manuscripts, films, maps and works of drama, music, art and important and exciting documents from American history are kept in library's archives. 
            There are materials on practically every subject to which members of Congress can refer. And now I would tell you about Lenin State Library. The Lenin Library is the central library and is one of the world's largest. 
            The old library building was built in 1786 on a hill opposite the Kremlin by Vasily Bashenov and was a typical example of a Moscow town residence of that time. Its new buildings were built in 1940. 
